...
{
  ros::init(argc, argv, "extra_square");
  ros::NodeHandle nh;
  ros::Publisher trajectory_pub =
      nh.advertise<trajectory_msgs::MultiDOFJointTrajectory>(
      mav_msgs::default_topics::COMMAND_TRAJECTORY, 10);

  ROS_INFO("Started extra_square for %s",nh.getNamespace().c_str());
  ...
  if (args.size() == 5) {
    ...
    ROS_ERROR("Usage: extra_square <x> <y> <z> <yaw_deg> [<delay>]\n");
    return -1;
  }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  ROS_INFO("Publishing extra_square on namespace %s: [%f, %f, %f].",
